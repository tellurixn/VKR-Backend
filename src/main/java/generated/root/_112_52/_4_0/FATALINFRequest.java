...
import generated.types._4_0.ДатаДокТип;
import generated.types._4_0.ОрганЗАГСНТип;
import generated.types._4_0.УдЛичнФЛСНТип;
import generated.types._4_0.ФИОПрТип;
...
public class FATALINFRequest {
    ...
    protected FATALINFRequest.СведОсн сведОсн;
    @XmlElement(name = "СведЗапрос", required = true)
    protected List<FATALINFRequest.СведЗапрос> сведЗапрос;
     ...
     * @return
     *     possible object is
     *     {@link FATALINFRequest.СведОсн }
     *     
     */
    public FATALINFRequest.СведОсн getСведОсн() {
        return сведОсн;
    }
     ...
     *     
     */
    public void setСведОсн(FATALINFRequest.СведОсн value) {
        this.сведОсн = value;
    }
     ...
     * {@link FATALINFRequest.СведЗапрос }
     * 
     * 
     */
    public List<FATALINFRequest.СведЗапрос> getСведЗапрос() {
        if (сведЗапрос == null) {
            сведЗапрос = new ArrayList<FATALINFRequest.СведЗапрос>();
        }
    ...
    public static class СведЗапрос {
        ...
        protected FATALINFRequest.СведЗапрос.СведАГС сведАГС;
        @XmlElement(name = "СведФЛ", required = true)
        protected FATALINFRequest.СведЗапрос.СведФЛ сведФЛ;
         ...
         * @return
         *     possible object is
         *     {@link FATALINFRequest.СведЗапрос.СведАГС }
         *     
         */
        public FATALINFRequest.СведЗапрос.СведАГС getСведАГС() {
            return сведАГС;
        }
         ...
         *     
         */
        public void setСведАГС(FATALINFRequest.СведЗапрос.СведАГС value) {
            this.сведАГС = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link FATALINFRequest.СведЗапрос.СведФЛ }
         *     
         */
        public FATALINFRequest.СведЗапрос.СведФЛ getСведФЛ() {
            return сведФЛ;
        }
         ...
         *     
         */
        public void setСведФЛ(FATALINFRequest.СведЗапрос.СведФЛ value) {
            this.сведФЛ = value;
        }
